...
def generate_fixed_numbers(num_count):
    """固定された数値のリストを生成する"""
    # 9389934469 と 2 を交互にリストに追加
    numbers = [9389934469 if i % 2 == 0 else 2 for i in range(num_count)]
    return numbers
...
def main():
    ...
    for trial in range(1, trials + 1):
        numbers = generate_fixed_numbers(numbers_per_trial)
