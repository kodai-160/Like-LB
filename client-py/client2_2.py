...
os.environ["NO_PROXY"] = "192.168.100.2"
...
def main():
    ...
    server = "192.168.100.2:9000"  # 単一のサーバーアドレスを使用
    ...
    with pd.ExcelWriter('prime_checks_fixed_number_single_server15-1.xlsx') as writer:
